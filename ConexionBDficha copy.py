...
def insertar_ficha_bd(nombre, apellido, dni, obra_social, propietario, telefono, nro_afiliado, nombre_medico, apellido_medico, especialidad, tipo_matricula,
    ...
    try:
        ...
        sql = "INSERT INTO paciente (nombre, apellido, dni, obra_social,proietario,sexo,telefono,nro_afiliado,) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        val = (nombre, apellido, dni, obra_social, propietario, telefono, nro_afiliado, nombre_medico, apellido_medico, especialidad, tipo_matricula,
        matricula, servicio, fecha, codigo, nombre_procedimiento, precio, tipo_tratamiento, siglas)
...
def actualizar_ficha(nombre, apellido, dni, obra_social, propietario, telefono, nro_afiliado, nombre_medico, apellido_medico, especialidad, tipo_matricula,
    matricula, servicio, fecha, codigo, nombre_procedimiento, precio, tipo_tratamiento, siglas):
