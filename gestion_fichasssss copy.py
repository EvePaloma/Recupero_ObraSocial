...
class GestionFicha(Frame):
    ...
    def agregar_ficha(self):
        ...
        campos = ["Nombre", "Apellido", "DNI", "Obra social", "Propietario del Plan","Teléfono", "Número de Afiliado", "Nombre del médico",
                  " Apellido del médico","Especialidad","Tipo de matrícula", "Matrícula","Servicio", "Fecha de prestación médica", "Código", "Nombre del procedimiento",
                    "Precio", "Tipo de tratamiento", "Siglas"]
        entradas = {}
        ...
        btn_nueva_ficha = Button(frame_agregar, text="Agregar", font=("Robot", 10),bg="#e6c885", command=lambda: insertar_ficha_bd(entradas, ventana_agregar))
