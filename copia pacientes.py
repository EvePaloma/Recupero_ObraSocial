...
class GestionPaciente(Frame):
    ...
    def abrir_ventana_paciente(self, paciente, id_seleccionado, modo="ver"):
        ...
        if modo == "ver":
            ...
            combo_obra_social.config(state="disabled")
            entradas["Obra Social"].config(state="disabled")
    ...
    def agregar_paciente(self):
        ...
        combo_obra_social = ttk.Combobox(frame_agregar, values=obras_sociales, width=40)
